...
自我介绍:
    ...
    贵公司采用移动端、PC端、协同端为上层架构，旨在构建数智化转型产品体系。有基础平台、项目管理平台、
    BIM协作平台等。合作公司还有阿里云这样的大厂，这也是我期待加入贵公司的原因

    4>我为什么适合这份工作
    (擅长JS，实战经验丰富)我很擅长JavaScript，我业余时间也写了很多项目和demo，对一些功能的实现很熟悉，
    能够很好的完成产品需求的功能。我对JS有很高的熟练度，所以我相信自己可以胜任这个岗位
*/
...
f(7) + f (6) + f(5) = 17 + 9 + 5 = 31
(6+5+4)+(5+4+3)+(4+3+2)
[f(5)+f(4)+f(3)] + [f(4)+f(3)+f(2)] + [f(3)+f(2)+f(1)] = f(5) + 2f(4) + 6
             1             1   1        1     1     1
f(7) = f(6) + f(5) + f(4) = 17
f(6) = f(5) + f(4) + f(3) = 9
f(5) = f(4)+f(3)+f(2) = 3 + 1 + 1 = 5
f(4) = f(3)+f(2)+f(1) = 3
6. == 和 ===的区别
